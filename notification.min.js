(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["NotificationComponent"] = factory();
	else
		root["NotificationComponent"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationDropdown = __webpack_require__(/*! ./NotificationDropdown */ 159);
	var NotificationApi = __webpack_require__(/*! ./NotificationApi */ 182);
	var CoachmarkApi = __webpack_require__(/*! ./CoachmarkApi */ 177);
	var FeedbackApi = __webpack_require__(/*! ./FeedbackApi */ 181);
	__webpack_require__(/*! ./style/main.scss */ 183);
	...
	function NotificationComponent(config) {
		...
		var userNotifications = NotificationApi.getInstance(config).getNotifications();
		...
		userNotifications.then(function (result) {
			if (_this2.reactComponent) {
				_this2.reactComponent.setState({
					notificationList: result
				});
			} else {
				_this2.notificationList = result;
			}
		}, function (error) {
			console.log(error);
		});
		...
		this.reactClass = React.createClass({
			...
			render: function render() {
				return React.createElement(
					"div",
					null,
					React.createElement(NotificationDropdown, { notificationList: this.state.notificationList })
				);
			}
		});
		...
		this.attachComponent = function (element) {
			...
			this.reactComponent = ReactDOM.render(React.createElement(this.reactClass, null), element);
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 1);
	var NotificationList = __webpack_require__(/*! ./NotificationList */ 160);
	...
	module.exports = React.createClass({
		...
		render: function render() {
			return React.createElement(
				"div",
				null,
				React.createElement("i", { className: "fa fa-lg fa-bell pointer", onClick: this.toggle }),
				React.createElement(
					"div",
					{ className: this.state.showDropdown ? "" : "hide" },
					React.createElement(
						"div",
						...
						React.createElement(
							...
							"Notifications",
							React.createElement("i", { className: "fa fa-remove close-dropdown pointer", onClick: this.closeDropdown })
						),
						React.createElement(NotificationList, { list: this.props.notificationList, notificationCloseDropdown: this.closeDropdown })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _oCoachMark = __webpack_require__(/*! o-coach-mark */ 161);
	
	var _oCoachMark2 = _interopRequireDefault(_oCoachMark);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var React = __webpack_require__(/*! react */ 1);
	var NotificationNode = __webpack_require__(/*! ./NotificationNode */ 171);
	var classNames = __webpack_require__(/*! classnames */ 172);
	var NotificationDetails = __webpack_require__(/*! ./NotificationDetails */ 176);
	var CoachmarkApi = __webpack_require__(/*! ./CoachmarkApi */ 177);
	var FeedbackApi = __webpack_require__(/*! ./FeedbackApi */ 181);
	var NotificationApi = __webpack_require__(/*! ./NotificationApi */ 182);
	...
	module.exports = React.createClass({
	  ...
	  *
	  **/
		showDetails: function showDetails(notification) {
			this.setState({
				isDetails: true,
	  ...
	  **/
		launchCoachmark: function launchCoachmark(notificationDetails) {
			...
			var notificationId = +notificationDetails.id;
	  ...
	  **/
		launchCoachmarkIfFromNewUrl: function launchCoachmarkIfFromNewUrl() {
	  ...
	  **/
		setupBackNextListener: function setupBackNextListener(notificationId) {
			var cmIds = cmState[notificationId].cmIds;
			document.addEventListener('o-cm-backNext-clicked', function (event) {
				...
				if (eventIndex !== cmState[notificationId].index) {
					console.log('no match: ' + eventIndex + ' !== ' + cmIds.indexOf(event.data.id));
	  ...
	  **/
		setupSubmitListener: function setupSubmitListener(notificationId) {
			var cmIds = cmState[notificationId].cmIds;
	  ...
	  **/
		setupLikeListener: function setupLikeListener(notificationId) {
			var cmIds = cmState[notificationId].cmIds;
			// Like event listener
	  ...
	  **/
		setupCancelListener: function setupCancelListener(notificationId) {
			var cmIds = cmState[notificationId].cmIds;
	  ...
	  **/
		cmListenerSetup: function cmListenerSetup(notificationId) {
	  ...
	  **/
		getDisplayCoachmark: function getDisplayCoachmark(notificationId) {
			var cmId = +cmState[notificationId].cmIds[cmState[notificationId].index];
			console.log('cmId: ', cmId);
	
			var coachmarkData = CoachmarkApi.getInstance().getCoachmark(cmId);
			coachmarkData.then(function (result) {
				if (this.redirectIfNewUri(result.uri, notificationId)) {
					return;
				}
				var cm = new _oCoachMark2.default(document.getElementById(result.element), result.options, function () {
					NotificationApi.getInstance().markAsRead(notificationId);
	  ...
	  **/
		redirectIfNewUri: function redirectIfNewUri(uri, notificationId) {
			if (!uri) {
				return false;
			}
	  ...
	  **/
		closeCoachmark: function closeCoachmark(coachmarkNode) {
	  ...
	  **/
		render: function render() {
			...
			if (!this.state.isDetails) {
				var notificationNodeList = this.props.list.map(function (notification) {
					return React.createElement(NotificationNode, { detailsClick: _this.showDetails.bind(_this, notification), title: notification.title, icon: notification.icon, key: notification.id, summary: notification.body.substring(0, 30) + "..." });
				});
				return React.createElement(
					"div",
				...
				return React.createElement(
					...
					React.createElement(
						"button",
						{ onClick: this.launchCoachmark.bind(this, this.state.notificationDetails) },
						"Launch Coachmark"
					),
					React.createElement(NotificationDetails, { title: this.state.notificationDetails.title, body: this.state.notificationDetails.body, previousClick: this.showList })
				);
			}
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./main.scss */ 162);
	module.exports = __webpack_require__(/*! ./main.js */ 166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CoachMark = __webpack_require__(/*! ./src/js/CoachMark */ 167);
	
	Object.defineProperty(exports, 'default', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_CoachMark).default;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _oComponentHandler = __webpack_require__(/*! o-component-handler */ 168);
	
	var _oComponentHandler2 = _interopRequireDefault(_oComponentHandler);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
	
	var CoachMark = function CoachMark(element, opts, callback) {
		var _this = this;
		...
		//Check options
		if (!opts) throw new Error('missing required parameter:' + ' you must include an options object');
	
		if (!opts.placement) opts.placement = "bottom";
	
		if (opts.placement !== 'left' && opts.placement !== 'right' && opts.placement !== 'top' && opts.placement !== 'bottom') throw new Error('invalid value for opts.placement: ' + 'must be one of the following - left, right, top, or bottom');
	
		if (!opts.text) throw new Error('missing required option: ' + 'you must specify text for the coach mark');
		...
		var internalText = 'textContent' in titleText ? 'textContent' : 'innerText';
		...
		if (opts.hasBack || opts.hasNext) {
			var backNextDiv = document.createElement('div');
			var back = document.createElement('button');
			var backSpan = document.createElement('span');
			var next = document.createElement('button');
			var nextSpan = document.createElement('span');
			var totalOfCoachMarksSpan = document.createElement('span');
		...
		if (opts.like) {
			(function () {
				...
				var likeDiv = undefined;
				var feedBack = undefined;
	
				_this.appendAnchor = function (parent, upDown, text, like) {
				...
				_this.appendAnchor(likeDiv, 'down', 'Not Great', 'dislike');
				_this.appendAnchor(likeDiv, 'up', 'I Like It', 'like');
		...
		var featurePosition = element.getBoundingClientRect();
		var featureHeight = element.offsetHeight;
	
		var markHeight = content.offsetHeight + 10;
		var markWidth = container.offsetWidth;
	...
	_oComponentHandler2.default.register({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./main.js */ 169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentHandler = __webpack_require__(/*! ./src/js/component-handler */ 170);
	
	Object.defineProperty(exports, 'default', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_componentHandler).default;
	  }
	});
	...
	*/
	function upgradeElementInternal(element, jsClass) {
		...
		if (dataUpgraded === null || dataUpgraded.indexOf(jsClass) === -1) {
			...
			var registeredClass = findRegisteredClass_(jsClass);
			if (registeredClass) {
				var Component = registeredClass.classConstructor;
				...
				var instance = new window[jsClass](element);
				createdComponents_.push(instance);
				elements_.set(element, instance);
			}
		}
	...
	module.exports = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"div",
					{ className: "notification-node--details-click", onClick: this.props.detailsClick },
					React.createElement(
						"div",
						{ className: "notification-node__icon" },
						React.createElement("i", { className: this.props.icon })
					),
					React.createElement(
						"div",
						{ className: "notification-node__summary" },
						React.createElement(
							"h1",
							null,
							" ",
						...
						React.createElement(
							"div",
							{ className: "notification-node__summary-description" },
							this.props.summary
						)
					)
				),
				React.createElement(
					"div",
					{ className: "notification-node__dismiss" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./index.js */ 173);
	module.exports = __webpack_require__(/*! ./bind.js */ 174);
	module.exports = __webpack_require__(/*! ./dedupe.js */ 175);
	...
	module.exports = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"div",
					{ className: "notification-details__title" },
					React.createElement(
						"h1",
						null,
						this.props.title
				...
				React.createElement(
					"div",
					{ className: "notification-details__body" },
					this.props.body
				),
				React.createElement(
					"div",
					{ className: "notification-details__buttons" },
					React.createElement(
						"button",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _oXhr = __webpack_require__(/*! o-xhr */ 178);
	
	var _oXhr2 = _interopRequireDefault(_oXhr);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function CoachmarkApi(config) {
		var url = config.cmApiUrl;
		var xAuth = config.cmPiToken;
		var acceptHeader = config.cmAcceptHeader;
		var contentType = config.cmContentTypeHeader;
	  ...
	  **/
		this.incrementViewCount = function (cmId) {
			var response = new Promise(function (resolve, reject) {
				var cmCount = +localStorage.getItem('cmId' + cmId) + 1;
		...
		function parseResponse(response, cmId) {
			...
			var coachmark = JSON.parse(responseObj.json);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./main.js */ 179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _xhr = __webpack_require__(/*! ./src/js/xhr */ 180);
...
/***/ function(module, exports) {
	...
	function createXhr(options) {
		...
		var request = settings.xhr || new XMLHttpRequest();
	
		function handleReadystatechange() {
			if (request.readyState !== 4) return;
			if (!isSuccess(request.status)) settings.onError(request);else settings.onSuccess(request);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function FeedbackApi(config) {
		var url = config.fbApiUrl;
		var xAuth = config.fbPiToken;
		var acceptHeader = config.fbAcceptHeader;
		var contentType = config.fbContentTypeHeader;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function NotificationApi(config) {
		var url = config.nfApiUrl;
		var xAuth = config.nfPiToken;
		var acceptHeader = config.nfAcceptHeader;
		var contentType = config.nfContentTypeHeader;
		var recipientId = config.nfRecipientId;
		...
		function parseResponse(response) {
			var userNotifications = JSON.parse(response)._embedded.usernotifications;

...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationApi = __webpack_require__(/*! ./NotificationApi */ 178);
	...
	function NotificationComponent(config) {
		...
		var userNotifications = notApi.getNotifications("console");
		...
		userNotifications.then(function (result) {
			if (_this2.reactComponent) {
				_this2.reactComponent.setState({ notificationList: result });
			} else {
	...
	module.exports = React.createClass({
		...
		launchCoachmark: function launchCoachmark(cmIds) {
			...
			document.addEventListener('o-cm-backNext-clicked', function (event) {
				...
				console.log('finding index for: ', event.data.id);
				var index = cmIds.indexOf(event.data.id);
				console.log('index: ', index);
	
				if (index < cmIds.length && event.data.type === 'nextButton') {
					index++;
				} else if (index > 0 && event.data.type === 'backButton') {
					index--;
				} else {
					return;
				}
				return this.loopCoachmarks(cmIds, index);
			}.bind(this));
	
			this.loopCoachmarks(cmIds, 0);
		},
	
		loopCoachmarks: function loopCoachmarks(cmIds, index) {
	
			// Set up the event listener for the next coachmark in the series
			//		let nextIndex = index + 1;
			//		if (nextIndex < cmIds.length) { // If there's a next coachmark, add a listener
			//			document.addEventListener('o-cm-backNext-clicked', function(event) {
			//				if ((cmIds[index] === event.data.id) && (event.data.type === 'nextButton')) {
			//					return this.loopCoachmarks(cmIds, nextIndex);
			//				}
			//			}.bind(this));
			//		}
	
			// Set up the listener for the previous button
			//		let prevIndex = index - 1;
			//		if (prevIndex >= 0) {
			//			document.addEventListener('o-cm-backNext-clicked', function(event) {
			//				if (cmIds[index] === event.data.id && event.data.type === 'backButton') {
			//					return this.loopCoachmarks(cmIds, prevIndex);
			//				}
			//			}.bind(this));
			//		}
	
			// Get the data from the service, display the current coachmark
			var coachmarkData = cmApi.getCoachmark(cmIds[index]);
			coachmarkData.then(function (result) {
				new _oCoachMark2.default(document.getElementById(result.element), result.options, function (id) {});
			}, function (error) {
		...
		render: function render() {
			...
			if (!this.state.isDetails) {
				...
				return React.createElement(
					...
					React.createElement(
						"button",
						{ onClick: this.launchCoachmark.bind(this, this.state.notificationDetails.cmId) },
						"Launch Coachmark"
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CoachMark = function CoachMark(element, opts, callback) {
		...
		if (opts.hasBack || opts.hasNext) {
			var eventOnClick = function eventOnClick(parent) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xhr = __webpack_require__(/*! o-xhr */ 179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./main.js */ 180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./src/js/xhr */ 181);
...
/***/ function(module, exports) {
	...
	function createXhr(options) {
		...
		function handleReadystatechange() {
			...
			if (!isSuccess(request.status)) options.onError(request);else options.onSuccess(request);
		}

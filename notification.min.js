...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
		...
		launchCoachmark: function launchCoachmark(cmIds, index) {
			this.showList();
		...
		getDisplayCoachmark: function getDisplayCoachmark(cmIds, index) {
			...
			coachmarkData.then(function (result) {
				...
				new _oCoachMark2.default(document.getElementById(result.element), result.options, function () {
					this.closeCoachmarkReloadPage();
				}.bind(this));
		...
		closeCoachmarkReloadPage: function closeCoachmarkReloadPage() {
			console.log('Mark as READ in the API, reloading page.'); // TODO
			var newUri = this.removeQueryParams(window.location.href);
			console.log(newUri);
		...
		redirectIfNewUri: function redirectIfNewUri(uri, cmIds, index) {
			...
			var qstart = uri.includes('?') ? '&' : '?';
			uri = uri + qstart + 'cmIds=' + encodeURIComponent(cmIds) + '&cmIndex=' + index;
			window.location.href = uri;
		},
	
		removeQueryParams: function removeQueryParams(uri) {
			var params = ['cmIds', 'cmIndex'];
		...
		launchCoachmarkFromUrl: function launchCoachmarkFromUrl() {
			...
			var cmIndex = this.parseQueryParams('cmIndex');
			var cmIds = this.parseQueryParams('cmIds');
		...
		parseQueryParams: function parseQueryParams(field, url) {
		...
		render: function render() {
			...
			if (!this.state.isDetails) {
				...
				return React.createElement(
					...
					React.createElement(
						"button",
						{ onClick: this.launchCoachmark.bind(this, this.state.notificationDetails.cmId, 0) },
						"Launch Coachmark"
					),

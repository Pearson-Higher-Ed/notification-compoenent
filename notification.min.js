...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationApi = __webpack_require__(/*! ./NotificationApi */ 181);
	var CoachmarkApi = __webpack_require__(/*! ./CoachmarkApi */ 177);
	__webpack_require__(/*! ./style/main.scss */ 182);
	...
	function NotificationComponent(config) {
		...
		var notApi = new NotificationApi();
	
		var userNotifications = notApi.getNotifications(config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
		...
		launchCoachmark: function launchCoachmark(cmIds) {
		...
		launchCoachmarkIfFromNewUrl: function launchCoachmarkIfFromNewUrl() {
			var cmIndex = localStorage.getItem('notifications.coachmark.index');
			localStorage.removeItem('notifications.coachmark.index');
	
			var cmIds = localStorage.getItem('notifications.coachmark.cmIds');
		...
		cmListenerSetup: function cmListenerSetup(cmIds) {
		...
		getDisplayCoachmark: function getDisplayCoachmark(cmIds, index) {
			var coachmarkData = CoachmarkApi.getInstance().getCoachmark(+cmIds[index]);
		...
		redirectIfNewUri: function redirectIfNewUri(uri, cmIds, index) {
			if (!uri) {
				return false;
			}
		...
		render: function render() {
			...
			if (!this.state.isDetails) {
				...
				return React.createElement(
					...
					React.createElement(
						"button",
						{ onClick: this.launchCoachmark.bind(this, this.state.notificationDetails.cmIds) },
						"Launch Coachmark"
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function CoachmarkApi(config) {
		...
		this.getCoachmark = function (cmId) {
			...
			var responseIs = new Promise(function (resolve, reject) {
				(0, _oXhr2.default)({

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NotificationComponent = __webpack_require__(1);
	...
	var not = new _NotificationComponent2.default(AppHeaderConfig, "notification");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NotificationApi = __webpack_require__(177);
	...
	var NotificationComponent = function NotificationComponent(config, elementId) {
	    var _this2 = this;

	    _classCallCheck(this, NotificationComponent);

	    var notApi = new _NotificationApi2.default(config);
	    ...
	    this.reactClass = _react2.default.createClass({
	        ...
	        render: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_NotificationDropdown2.default, { notificationList: this.state.notificationList })
	            );
	        }
	    });
	    ...
	    this.reactComponent = _reactDom2.default.render(_react2.default.createElement(this.reactClass, null), document.getElementById(elementId));
	};

	exports.default = NotificationComponent;


	document.body.addEventListener('o.InitMyComponent', function (e) {
	    return new NotificationComponent(e.detail.config, e.detail.elementId);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NotificationList = __webpack_require__(161);
	...
	module.exports = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('i', { className: 'fa fa-lg fa-bell pointer', onClick: this.toggle }),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							'Notifications',
							_react2.default.createElement('i', { className: 'fa fa-remove close-dropdown pointer', onClick: this.closeDropdown })
						),
						_react2.default.createElement(_NotificationList2.default, { list: this.props.notificationList, notificationCloseDropdown: this.closeDropdown, apiConfig: this.props.apiConfig })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _oCoachMark = __webpack_require__(162);
	...
	var cmState = {};
	var notApi = void 0; // use getNotificationApi()
	var cmApi = void 0; // use getCoachmarkApi()
	var fbApi = void 0; // use getFeedbackApi()
	...
	module.exports = _react2.default.createClass({
	  ...
	  **/
		getNotificationApi: function getNotificationApi() {
			if (!notApi && this.props.apiConfig) {
				notApi = new _NotificationApi2.default(this.props.apiConfig);
			}
			return notApi;
		},
	  ...
	  **/
		getCoachmarkApi: function getCoachmarkApi() {
			if (!cmApi && this.props.apiConfig) {
				cmApi = new _CoachmarkApi2.default(this.props.apiConfig);
			}
			return cmApi;
		},
	  ...
	  **/
		getFeedbackApi: function getFeedbackApi() {
			if (!fbApi && this.props.apiConfig) {
				fbApi = new _FeedbackApi2.default(this.props.apiConfig);
			}
			return fbApi;
		},
	  ...
	  **/
		setupBackNextListener: function setupBackNextListener(masterpieceId) {
			var cmIds = cmState[masterpieceId].cmIds;
	  ...
	  **/
		setupLikeListener: function setupLikeListener(masterpieceId) {
			var cmIds = cmState[masterpieceId].cmIds;
	  ...
	  **/
		setupSubmitListener: function setupSubmitListener(masterpieceId) {
			var cmIds = cmState[masterpieceId].cmIds;
			document.addEventListener('o-cm-submit-clicked', function (event) {
				if (cmIds.indexOf(event.data.id) !== cmState[masterpieceId].index) {
					return; // event wasn't meant for this instance of this listener
				}
				this.getFeedbackApi().submitFeedback(masterpieceId, cmState[masterpieceId].userId, cmState[masterpieceId].targetUserRole, event.data.payload, cmState[masterpieceId].likeCmSeries);
	  ...
	  **/
		setupCancelListener: function setupCancelListener(masterpieceId) {
			var cmIds = cmState[masterpieceId].cmIds;
	  ...
	  **/
		cmListenerSetup: function cmListenerSetup(masterpieceId) {
	  ...
	  **/
		getDisplayCoachmark: function getDisplayCoachmark(masterpieceId) {
			var cmId = parseInt(cmState[masterpieceId].cmIds[cmState[masterpieceId].index]);

			var coachmarkData = this.getCoachmarkApi().getCoachmark(cmId);
	  ...
	  **/
		redirectIfNewUri: function redirectIfNewUri(uri, masterpieceId) {
			if (!uri) {
				return false;
			}
		...
		render: function render() {
			...
			if (!this.state.isDetails) {
				var notificationNodeList = this.props.list.map(function (notification) {
					return _react2.default.createElement(_NotificationNode2.default, { detailsClick: _this.showDetails.bind(_this, notification), title: notification.title, icon: notification.icon, key: notification.id, summary: notification.body.substring(0, 30) + '...' });
				});
				return _react2.default.createElement(
					'div',
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_NotificationDetails2.default, { title: this.state.notificationDetails.title, body: this.state.notificationDetails.body, previousClick: this.showList })
				);
			}
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CoachMark = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _oComponentHandler = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentHandler = __webpack_require__(171);
	...
	function upgradeElementInternal(element, jsClass) {
		...
		if (dataUpgraded === null || dataUpgraded.indexOf(jsClass) === -1) {
			...
			if (registeredClass) {
				...
				var _instance = new window[jsClass](element);
				createdComponents_.push(_instance);
				elements_.set(element, _instance);
			}
		}
	}
	...
	var NotificationApi = function () {
		...
		_createClass(NotificationApi, [{
			...
			value: function getNotifications() {
				...
				var response = new Promise(function (resolve, reject) {
					var request = new Request(_this.url + '/usernotifications/recipientid/' + _this.recipientId, {
						method: 'GET',
						mode: 'cors',
						headers: {
							'X-Authorization': _this.xAuth,
			...
			key: 'marAsRead',
			value: function marAsRead(userNotificationId) {
				var _this2 = this;

				var response = new Promise(function (resolve, reject) {
					var request = new Request(_this2.url + '/readusernotifications/' + userNotificationId + '/true', {
						method: 'PUT',
						mode: 'cors',
						headers: {
							'X-Authorization': _this2.xAuth,

...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationApi = __webpack_require__(1);
	var configuration = __webpack_require__(5);
	var React = __webpack_require__(6);
	var ReactDOM = __webpack_require__(163);
	var NotificationDropdown = __webpack_require__(164);
	...
	function Notification(element, env, configOverride) {
		...
		ReactDOM.render(React.createElement(NotificationDropdown, null), element);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6);
	var NotificationList = __webpack_require__(165);
	...
	module.exports = React.createClass({
		...
		render: function render() {
			return React.createElement(
				"div",
				null,
				React.createElement("i", { className: "fa fa-bell pointer", onClick: this.toggle }),
				React.createElement(
					"div",
					...
					React.createElement(
						...
						React.createElement(
							...
							"Notifications",
							React.createElement("i", { className: "fa fa-times close-dropdown pointer", onClick: this.closeDropdown })
						),

...
/***/ function(module, exports, __webpack_require__) {
	...
	function NotificationComponent(element, env, configOverride) {
		...
		ReactDOM.render(React.createElement(NotificationDropdown, { config: config }), element);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationApi = __webpack_require__(169);
	...
	module.exports = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			var notApi = new NotificationApi(this.props.config);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(NotificationList, { list: this.state.notificationList })
					)
				)
			);
		}
	...
	module.exports = React.createClass({
		...
		render: function render() {
			var notificationNodeList = this.props.list.map(function (notification) {
				return React.createElement(NotificationNode, { title: notification.title, icon: notification.icon, key: notification.id, summary: notification.body.substring(0, 30) + "..." });
			});
			return React.createElement(
				"div",
				null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notification.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notification.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xhr = __webpack_require__(170);

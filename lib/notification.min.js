...
/***/ function(module, exports, __webpack_require__) {
	...
	var configuration = __webpack_require__(1);
	var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(159);
	var NotificationDropdown = __webpack_require__(160);
	...
	function NotificationComponent(element, env, configOverride) {
		...
		var notApi = new NotificationApi(config);
		var userNotifications = notApi.getNotifications("console");

		userNotifications.then(function (result) {
			ReactDOM.render(React.createElement(NotificationDropdown, { notificationList: result }), element);
		}, function (error) {
			console.log(error);
		});
...
/***/ function(module, exports) {
	...
	module.exports = {
		dev: {
			"notification-api": "https://notifications-api.stg-prsn.com"
		},
		stg: {
			"notification-api": "https://notifications-api.stg-prsn.com"
		},
		prd: {
			"notification-api": "http://grid.pearson.com/notifications"
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var NotificationList = __webpack_require__(161);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(NotificationList, { list: this.props.notificationList })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationNode = __webpack_require__(166);
	var classNames = __webpack_require__(169);
	var NotificationDetails = __webpack_require__(173);
	...
	module.exports = React.createClass({
		...
		showDetails: function showDetails(notification) {
			...
			this.notificationDetails = React.createElement(NotificationDetails, { title: notification.title, body: notification.body, previousClick: this.showList });
		...
		render: function render() {
			...
			var notificationNodeList = this.props.list.map(function (notification) {
				var detailsClick = _this.showDetails.bind(_this, notification);
				return React.createElement(NotificationNode, { detailsClick: detailsClick, title: notification.title, icon: notification.icon, key: notification.id, summary: notification.body.substring(0, 30) + "..." });
			});
			...
			this.listContainer = React.createElement(
				"div",
				{ className: listClassNames },
				notificationNodeList
			);
			var detailClassNames = classNames({
				"notification-container__details": true,
				"notification-container--hide": !this.state.isDetails
			});
			this.detailsContainer = React.createElement(
				"div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationList.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationList.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".notification-container .notification-container--hide {\n  display: none; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationNode.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationNode.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".notification-node {\n  height: 52px;\n  border: solid 1px #ddd;\n  margin-bottom: 10px; }\n  .notification-node .notification-node--details-click {\n    cursor: pointer;\n    height: 100%;\n    float: left; }\n  .notification-node .notification-node__icon {\n    float: left;\n    border-right: 1px solid #ddd;\n    padding: 10px; }\n  .notification-node .notification-node__summary {\n    float: left;\n    height: 100%; }\n    .notification-node .notification-node__summary h1 {\n      font-size: 16px;\n      padding-left: 10px;\n      margin-bottom: 0;\n      margin-top: 10px;\n      font-weight: bold; }\n    .notification-node .notification-node__summary .notification-node__summary-description {\n      padding-left: 10px; }\n  .notification-node .notification-node__dismiss {\n    float: right;\n    margin: 10px;\n    cursor: pointer; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
		...
		goToDestination: function goToDestination() {},
		remindLater: function remindLater() {},
		render: function render() {
			return React.createElement(
				"div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationDetails.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationDetails.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationDropdown.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./notificationDropdown.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
